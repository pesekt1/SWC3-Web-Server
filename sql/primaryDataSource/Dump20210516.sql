...
INSERT INTO `order_item_notes` VALUES (1,'first note',1,2),(2,'second note',1,2),(4,'note',1,2),(8,'note 1',35,1),(9,'note 2',35,1),(10,'note 1',35,2),(11,'note 2',35,2),(20,'note 1',44,1),(21,'note 2',44,1),(22,'note 1',44,2),(23,'note 2',44,2);
...
INSERT INTO `order_items` VALUES (1,2,4,3.74),(2,1,2,9.10),(2,4,4,1.66),(2,6,2,2.94),(3,3,10,9.12),(4,3,7,6.99),(4,10,7,6.40),(5,2,3,9.89),(6,1,4,8.65),(6,2,4,3.28),(6,3,4,7.46),(6,5,1,3.45),(7,3,7,9.17),(8,5,2,6.94),(8,8,2,8.59),(9,6,5,7.28),(10,1,10,6.01),(10,9,9,4.28),(11,1,2,2.50),(12,1,2,2.50),(13,2,3,1.10),(13,3,1,2.10),(35,1,2,2.00),(35,2,5,3.00),(44,1,2,2.00),(44,2,5,3.00);
...
INSERT INTO `orders` VALUES (1,6,'2020-01-30',1,'gold customer',NULL,NULL),(2,7,'2020-02-02',2,NULL,'2018-08-03',4),(3,8,'2019-12-01',1,NULL,NULL,NULL),(4,2,'2017-01-22',1,NULL,NULL,NULL),(5,5,'2017-08-25',2,'gold customer','2017-08-26',3),(6,10,'2018-11-18',1,'Aliquam erat volutpat. In congue.',NULL,NULL),(7,2,'2018-09-22',2,NULL,'2018-09-23',4),(8,5,'2018-06-08',2,'gold customer','2017-08-26',NULL),(9,10,'2017-07-05',2,'Nulla mollis molestie lorem. Quisque ut erat.','2017-07-06',1),(10,6,'2021-04-22',2,'gold customer','2018-04-23',2),(11,1,'2020-01-01',1,NULL,NULL,NULL),(12,1,'2020-01-01',1,NULL,NULL,NULL),(13,5,'2019-01-01',2,'gold customer',NULL,NULL),(14,1,'2020-01-01',1,NULL,NULL,NULL),(15,1,'2020-01-01',1,NULL,NULL,NULL),(16,1,'2020-01-01',1,NULL,NULL,NULL),(35,6,'2020-01-30',1,'gold customer',NULL,NULL),(44,6,'2020-01-30',1,'gold customer',NULL,NULL);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017*/ /*!50003 TRIGGER `payments_after_insert` AFTER INSERT ON `payments` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `payments_after_delete` AFTER DELETE ON `payments` FOR EACH ROW begin
...
INSERT INTO `roles` VALUES (1,'ROLE_CUSTOMER'),(2,'ROLE_ADMIN'),(3,'ROLE_EMPLOYEE');
...
INSERT INTO `tutorials` VALUES (1011,'d1',_binary '\0','t1'),(1012,'d2',_binary '\0','t2'),(1013,'string',_binary '\0','string');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE FUNCTION `CustomerLevel`(points int) RETURNS varchar(20) CHARSET utf8mb4
    DETERMINISTIC
BEGIN
...
-- Dump completed on 2021-05-16  9:04:51
